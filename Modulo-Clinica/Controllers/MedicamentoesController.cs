...
namespace Modulo_Clinica.Controllers
{
    ...
    public class MedicamentoesController : ControllerBase
    {
        ...
        public MedicamentoesController(ClinicaContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != medicamento.MedicamentosId)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Medicamento>> PostMedicamento(Medicamento medicamento)
        {
            ...
            return CreatedAtAction("GetMedicamento", new { id = medicamento.MedicamentosId }, medicamento);
        }
